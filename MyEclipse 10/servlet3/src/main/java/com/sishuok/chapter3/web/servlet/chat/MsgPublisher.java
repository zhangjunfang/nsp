...
public class MsgPublisher {
    ...
    private volatile Map<String, Queue<AsyncContext>> usernameToAsyncContextMap = new ConcurrentHashMap<String, Queue<AsyncContext>>();
    ...
    public Collection<String> getLoginUsers() {
        return new HashSet<String>(usernameToAsyncContextMap.keySet());
    }
    ...
    public void startAsync(HttpServletRequest req, final String username) {
        ...
        if(queue == null) {
            queue = new ConcurrentLinkedDeque<AsyncContext>();
