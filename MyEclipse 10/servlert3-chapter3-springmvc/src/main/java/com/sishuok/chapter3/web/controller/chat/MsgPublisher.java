...
public class MsgPublisher {
    ...
    private volatile Map<String, Queue<DeferredResult<String>>> usernameToDeferredResultMap = new ConcurrentHashMap<String, Queue<DeferredResult<String>>>();
    ...
    public Collection<String> getLoginUsers() {
        return new HashSet<String>(usernameToDeferredResultMap.keySet());
    }
    ...
    public DeferredResult<String> startAsync(final String username) {
        ...
        Queue<DeferredResult<String>> queue = usernameToDeferredResultMap.get(username);
        if(queue == null) {
            queue = new ConcurrentLinkedDeque<DeferredResult<String>>();
