...
$.fn.themeswitcher = function(settings){
	...
	var switcherpane = $('<div class="jquery-ui-themeswitcher"><div id="themeGallery">	<ul>			<li><a href="css/themes/cupertino/jquery.ui.all.css">			<img src="images/themeroller/theme_30_cupertino.png" alt="Cupertino" title="Cupertino" />			<span class="themeName">Cupertino</span>				</a></li></ul></div></div>').find('div').removeAttr('id');
	...
	var button_default = {
		...
		fontSize: '11px',
		color: '#666',
		background: '#eee url(images/themeswitchertool/buttonbg.png) 50% 50% repeat-x',
	...
	.find('.jquery-ui-themeswitcher-icon').css({
		...
		width: '16px',
		height: '16px',
		background: 'url(images/themeswitchertool/icon_color_arrow.gif) 50% 50% no-repeat'
	});	
	//pane css
	switcherpane.css({
		position: 'absolute',
	...
	.find('li').hover(
		function(){ 
			$(this).css({
				'borderColor':'#555',
				'background': 'url(images/themeswitchertool/menuhoverbg.png) 50% 50% repeat-x',
				cursor: 'pointer'
			}); 
		},
		function(){ 
