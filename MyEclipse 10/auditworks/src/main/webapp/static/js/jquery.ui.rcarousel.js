(function ($) {
	$.widget("ui.rcarousel", {
		_create: function() {
			...
			// save all children of root element in 鈥榩aths鈥�array
			this._saveElements();
		...
		_generatePages: function() {
			...
			// creates 3 pages for 鈥榲isible: 5鈥�and 鈥榮tep: 4鈥�
			// [ABCDE], [EFGHI], [FGHIJ]
			...
			function _paginate() {
				...
				while ( !_islastPage(data.pages[data.pages.length - 1]) || _isBeginning ) {
					...
					// we must assure that we have always 鈥榲isible鈥�(5 in our example) elements
					...
					if ( _complement ) {
						...
						// first add old elemets; for 3rd page it adds [FGHI鈥
		...
		_goToPrevPage: function( by ) {
			...
			// CD page was shown (from 5 elements) 鈥榑theSame鈥�is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for 鈥榲isible鈥�= 6 and
			// 鈥榮tep鈥�= 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 3rd
		...
		_goToNextPage: function( by ) {
			...
			// ABCD page was shown (from 5 elements) 鈥榑theSame鈥�is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for 鈥榲isible鈥�= 6 and
			// 鈥榮tep鈥�= 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 2nd
