...
<c:if test="${updateSucess==null}">
	<form:form method="POST" commandName="tree" action="tree/updateNode.htm">
		...
		<table>
			...
			<tr>
				<td>pid :</td>
				<td><input type="text" name="pId" value="${param.pid}"
					readonly="readonly"></td>
				<td><form:input path="pId" cssClass="error" /></td>
			</tr>
			<tr>
				<td>name :</td>
	...
	<c:if test="${updateSucess!=null}">
		...
		<div align="center">
			友情提示：<br>
			<h1 style="color: red">${updateSucess}</h1>
